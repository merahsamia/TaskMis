...
<div class="auth-card">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="text-center">Register to Task Tracking MIS</h3>
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('register')}}" method="POST">
                        ...
                        <div class=" form-group my-1">
                            ...
                            value="{{old('password_confirmation')}}" autocomplete="new-password" placeholder="Confirm your password" required>
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
